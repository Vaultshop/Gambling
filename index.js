...
// ========== KONFIGŪRACIJA ==========
const config = {
  ownerId: '', // tavo Discord ID (nebūtina)
  adminRoleId: null, // admin rolės ID (null = owner + Administrator teisė)
  ticketCategoryId: null, // kategorijos ID ticketams (null = pagrindam)
  brand: 'Ticket',
